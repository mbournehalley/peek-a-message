...
public class MyActivity extends FragmentActivity implements
        ...
        public void onClick(DialogInterface dialog, int which) {
            switch (which) {
                case 0: // Take Photo
                    ...
                    if (mMediaUri == null) {
                        //display an error
                        Toast.makeText(MyActivity.this,"No SD card", Toast.LENGTH_LONG).show();
                    }
                    else {
                ...
                case 3: // Choose a video
                    ...
                    Toast.makeText(MyActivity.this, R.string.video_size_limit,
        ...
        if(resultCode == RESULT_OK){
            ...
            if( requestCode == CHOOSE_PHOTO_REQUEST || requestCode == CHOOSE_VIDEO_REQUEST){
                ...
                if ( requestCode == CHOOSE_VIDEO_REQUEST) {
                    //Filter file size if less than 10MB
                    int fileSize = 0;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id) {
            case R.id.action_messageText:
                Intent intentMessage = new Intent(this, SendMessage.class);
